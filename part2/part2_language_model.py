...
print("Raw MLE is insufficient for unseen bigrams because any test bigram not seen in training")
print("gets probability 0, causing the entire sequence probability to be 0 and perplexity to be infinity.")
print("Laplace smoothing adds 1 to all bigram counts (and |V| to denominator) to guarantee non-zero probabilities.")
print("\n" + "="*50 + "\n")
